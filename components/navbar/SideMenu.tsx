  ...
  return (
    <div
      className={classNames(
        show ? "bg-opacity-25" : "bg-opacity-0 duration-700",
        "absolute inset-0 bg-slate-500 h-screen z-40 transition duration-500 ease-out pointer-events-none overscroll-none"
      )}
    >
      <div
        className={classNames(
