...
export default function TestimonialsSection() {
  return (
    <section className="h-96">
      <div className="w-full h-full mx-auto grid grid-cols xl:grid-cols-2 xl:px-32 px-8 mb-10">
        <div className="h-full w-full flex justify-center items-center">
          <div className="flex w-full justify-start flex-col">
            ...
            <p className="xl:text-xl w-5/6 leading-8">
              ...
              min service, så benyt gerne muligheden til at sende mig en e-mail.
            </p>
          </div>
        </div>
        <div className="order-first xl:order-last flex justify-center items-center w-full h-full relative mb-12 xl:mb-0">
          <div className="max-w-[1400px] max-h-[780px] h-full w-full">
